  ...
  return (
    <Segment style={{ padding: "8em 0em" }} vertical>
      ...
      <Grid.Row centered>
        ...
        <Grid.Row centered>
          <div className="yellow" style={{ display: "flex", border: "3px solid black", width: "100%", justifyContent: "space-between", paddingLeft: isMobile ? "20px" : "100px", paddingRight: isMobile ? "20px" : "100px", margin: "10px" }}>
          ...
          <Table.Body>
            ...
            <Table.Row>
              {Array.from({ length: 4 }, (_, index) => (
                <Table.Cell key={index} className="video-container">
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <p className="small bold "><span className="inline" style={{ width: "auto" }}><span style={{ fontSize: "26px" }}>V</span>IDEO <span style={{ fontSize: "26px" }}>{index + 5}</span></span></p>
                  </div>
                  <div>Video content here</div>
                </Table.Cell>
              ))}
